...
def train_mnist_vae_dp(
    ...
    **kwargs
    ...
    """
    Trains a separate DP-VAE for each MNIST label and generates synthetic data.
    """
    ...
    print(f"[MNIST-DP-FedAug] Found labels: {unique_labels.tolist()}")
    ...
    for lbl in unique_labels:
        ...
        print(f"[MNIST-DP-FedAug] Label {lbl.item()}: {subset_data.shape[0]} real -> {synth_num} synthetic")
        ...
        print(f"[MNIST-DP-FedAug] Label {lbl.item()} complete. ε={eps_str}")
